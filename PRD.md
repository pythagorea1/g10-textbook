...
- [ ] Task 2: eurozone/01_central_bank.html — ECB総裁・理事会メンバーの確認。Lagarde任期、最新政策（利下げサイクル等）を反映
- [ ] Task 3: uk/01_central_bank.html — BOE総裁Bailey・MPC委員の確認。政策金利推移の最新化
- [ ] Task 4: switzerland/01_central_bank.html — SNB議長をMartin Schlegelに更新。Thomas Jordan退任（2024年9月）を反映。理事会メンバー更新
